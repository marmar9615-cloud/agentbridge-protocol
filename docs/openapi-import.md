...
```bash
npx @marmarlabs/agentbridge-cli generate openapi https://api.acme.com/openapi.json
```
...
```bash
$ npx @marmarlabs/agentbridge-cli generate openapi packages/openapi/fixtures/simple-store.openapi.json
...
5. **Validate.** `npx @marmarlabs/agentbridge-cli validate ./your.agentbridge.json`
